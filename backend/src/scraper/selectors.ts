export const productSelectors = {
    ...
    image: "img",
    currentPrice: ".price .woocommerce-Price-amount.amount, .price .amount, .price bdi",
    salePrice: ".price ins .amount, .price ins bdi",
    originalPrice: ".price del .amount, .price del bdi",
    canonicalPriceAmount: ".price .woocommerce-Price-amount.amount, .price .amount, .price bdi",
